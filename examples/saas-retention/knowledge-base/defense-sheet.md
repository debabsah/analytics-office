...
| "Finance says total revenue grew about 2%. You say retention is 108%. Which one is wrong?" | Gestured at "NRR is a cohort measure, Finance is total GL revenue," but could not state the bridge or explain why the gap is that wide. | **cracked** |
...
- **Close the Finance reconciliation (the one that cracked).** This is the contract's
  open `[needs decision]`. Until Finance and RevOps agree the bridge and which
  retention number the board sees, do not present NRR next to Finance's revenue. It is
...
- **Readiness verdict:** **not yet.** The headline holds on definition, but the
  unreconciled Finance gap is a board-sinking hole and the recommendation is not yet
